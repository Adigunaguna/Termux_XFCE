...
wget https://github.com/Adigunaguna/Termux_XFCE/raw/main/xfce.sh
wget https://github.com/Adigunaguna/Termux_XFCE/raw/main/proot.sh
wget https://github.com/Adigunaguna/Termux_XFCE/raw/main/utils.sh
chmod +x *.sh
